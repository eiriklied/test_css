...
Cactus.expect('h1', 'font-weight').toEqual('bold')
...
Cactus.expect('h2', 'font-weight').toEqual('normal')
...
Cactus.expect('h3', 'font-weight').toEqual('bold')
...
Cactus.expect('h4', 'font-weight').toEqual('normal')
